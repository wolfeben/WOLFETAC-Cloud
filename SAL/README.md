...
Pallet auto-fill (app version 1.1.0.21):

- On a Draft plan, **Fill pallets** creates physical pallets and exact SKU components from the unallocated exact balance in one action. It never replaces an existing allocation or auto-allocates a fill-group balance.
