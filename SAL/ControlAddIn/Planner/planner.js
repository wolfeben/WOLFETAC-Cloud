                ...
                '<div class="sal-layout">',
                    '<aside class="sal-queue">',
                        '<div class="sal-queue-header">',
                            ...
                            '<div class="sal-new-demand">',
                                '<span class="sal-new-demand-label">Create new order</span>',
                                '<div class="sal-new-demand-actions">',
                                    '<button class="sal-create-order-button" type="button" data-action="new-sales-order" data-server-action><span>＋</span>Sales order</button>',
                                    '<button class="sal-create-order-button" type="button" data-action="new-transfer-order" data-server-action><span>＋</span>Transfer order</button>',
                                '</div>',
                            '</div>',
    ...
    function openAutoFill() {
        openDialog([
            '<div class="sal-dialog" role="dialog" aria-modal="true" aria-labelledby="sal-dialog-title">',
                ...
                '<button class="sal-dialog-close" type="button" data-action="close-dialog" aria-label="Close">×</button></div>',
                '<p class="sal-dialog-intro">Fill existing draft pallets from matching order lines, then create additional pallets where active rules define the size. For a blank pallet with several sizes and no rule, tick Allow mixed: its entered target is the maximum, and the final target adjusts to the quantity allocated. Quantities stay in the order’s unit; no tray conversion is assumed.</p>',
                '<div class="sal-dialog-grid">',
                    '<label class="is-wide"><input id="sal-dialog-allow-mixed" type="checkbox"> Allow mixed sizes from the same order, destination and unit, including filling a blank pallet</label>',
                '</div>',
