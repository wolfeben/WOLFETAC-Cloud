page 50251 "TAC Pool Group Card"
{
    ...
    var
        ConfirmProvisionalQst: Label 'Provisionally close Pool Group %1?', Comment = '%1 = Pool Group Code';
    ...
    begin
        ...
        if not ConfirmManagement.GetResponseOrDefault(StrSubstNo(Question, Rec."Pool Group Code"), false) then
            exit;
    ...
    var
        ...
        ConfirmManagement: Codeunit "Confirm Management";
    begin
        if not ConfirmManagement.GetResponseOrDefault(StrSubstNo(ConfirmResumeLastCloseQst, Rec."Pool Group Code"), false) then
            exit;
