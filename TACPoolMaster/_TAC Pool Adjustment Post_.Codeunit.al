codeunit 50274 "TAC Pool Adjustment Post"
{
    ...
    var TRACodeTok: Label 'TRA', Locked = true;
    ...
    begin
        if PoolAdjustment.Posted then Error(AlreadyPostedErr, PoolAdjustment."Adjustment ID");
    ...
    local procedure WriteEntry(var PoolAdjustment: Record "TAC Pool Adjustment"; TransTypeCode: Code[10]; PoolCode: Code[20]; SignedKgs: Decimal)
    var
        PoolLedgerEntry: Record "TAC Pool Ledger Entry";
    begin
