page 50254 "TAC Pool Adjustment"
{
    ...
    layout
    {
        area(Content)
        {
            repeater(Group)
            {
                field("Adjustment ID"; Rec."Adjustment ID") { Editable = false; }
                field("Date"; Rec."Date") { }
                ...
                field("Posted By"; Rec."Posted By") { Editable = false; }
                field("Posted DateTime"; Rec."Posted DateTime") { Editable = false; }
            }
        }
    }
