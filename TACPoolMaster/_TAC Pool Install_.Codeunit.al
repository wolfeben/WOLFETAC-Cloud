codeunit 50278 "TAC Pool Install"
{
    ...
    var
        PoolGroupNoSeriesTok: Label 'POOL-GRP', Locked = true;
    ...
    begin
        ...
        if PoolSetup."Internal Prov. 1 %" = 0 then
            PoolSetup."Internal Prov. 1 %" := 40;
        if PoolSetup."Internal Prov. 2 %" = 0 then
            PoolSetup."Internal Prov. 2 %" := 40;
        if PoolSetup."External Prov. 1 %" = 0 then
            PoolSetup."External Prov. 1 %" := 50;
