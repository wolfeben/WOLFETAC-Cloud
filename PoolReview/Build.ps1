...
$taskApp = Join-Path $taskOutput 'WOLFE_TAC Pool Review_0.4.0.2.app'
...
& $Compiler "/project:$taskTests" "/packagecachepath:$taskTestSymbols" "/out:$taskTestOutput\WOLFE_TAC Pool Review Tests_0.4.0.2.app" "/errorlog:$taskTestOutput\compile.json"
