...
$taskApp = Join-Path $taskOutput 'WOLFE_TAC Pool Review_0.6.0.1.app'
...
& $Compiler "/project:$taskTests" "/packagecachepath:$taskTestSymbols" "/out:$taskTestOutput\WOLFE_TAC Pool Review Tests_0.6.0.1.app" "/errorlog:$taskTestOutput\compile.json"
