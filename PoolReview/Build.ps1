...
$taskApp = Join-Path $taskOutput 'WOLFE_TAC Pool Review_0.5.0.0.app'
...
& $Compiler "/project:$taskTests" "/packagecachepath:$taskTestSymbols" "/out:$taskTestOutput\WOLFE_TAC Pool Review Tests_0.5.0.0.app" "/errorlog:$taskTestOutput\compile.json"
